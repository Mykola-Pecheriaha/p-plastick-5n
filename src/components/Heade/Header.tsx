                      ...
                      {activeSubMenu === "services" && item.submenu && (
                        <div className={styles.subMenu}>
                          {item.submenu.map((section, sectionIndex) => (
                            <div key={sectionIndex} className={styles.subMenuSection}>
                              <p className={styles.subMenuTitle}>{section.title}</p>
                        ...
                        <div className={styles.mobileSubMenu}>
                          {item.submenu.map((section, sectionIndex) => (
                            <div key={sectionIndex} className={styles.mobileSubMenuSection}>
                              <p className={styles.mobileSubMenuTitle}>{section.title}</p>
                              {section.items.map(subItem => (
                                <Link
                                  key={subItem.path}
                                  href={subItem.path}
